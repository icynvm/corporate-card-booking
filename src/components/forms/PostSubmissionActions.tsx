    ...
    return (
        <div className="max-w-2xl mx-auto animate-slide-up">
            ...
            <GlassCard className="mb-6">
                <h3 className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider mb-4">Request Summary</h3>
                <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        <span className="text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Requester</span>
                        <p className="font-medium text-gray-700 dark:text-gray-200">{formData.fullName}</p>
                    </div>
                    <div>
                        <span className="text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Team</span>
                        <p className="font-medium text-gray-700 dark:text-gray-200">{formData.department}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        <span className="text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Billing Type</span>
                        <p className="font-medium text-gray-700 dark:text-gray-200">
                            {formData.billingType.replace("_", " ")}
                        </p>
                    </div>
                    <div className="col-span-2">
                        <span className="text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Objective</span>
                        <p className="font-medium text-gray-700 dark:text-gray-200">{formData.objective}</p>
                    </div>
                    {formData.promotionalChannels && formData.promotionalChannels.length > 0 && (
                        <div className="col-span-2">
                            <span className="text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Channels</span>
            ...
            {/* Action Buttons */}
            <GlassCard>
                <h3 className="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase tracking-wider mb-4">Next Steps</h3>
                <div className="flex flex-col gap-3">
                    ...
                    <p className="text-xs text-center text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500 mt-2">
