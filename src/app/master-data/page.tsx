...
import { EventMaster } from "@/lib/types";
        ...
        <div className="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-1">
                        Master <span className="gradient-text">Data Management</span>
                    </h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        Manage Event IDs and Account Codes for pattern matching.
                    </p>
                </div>
                <button
            ...
            {isAdding && (
                <div className="mb-8 animate-slide-down">
                    <GlassCard>
                        <h2 className="text-lg font-semibold mb-4">Add Master Entry</h2>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan={4} className="px-6 py-12 text-center text-gray-400">No master data found.</td>
                                </tr>
                            ) : (
                                events.map((event) => (
                                    <tr key={event.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group">
                                        <td className="px-6 py-4">
                                            <span className="font-medium text-gray-900 dark:text-gray-100">{event.event_id}</span>
                                        </td>
                                        <td className="px-6 py-4 text-gray-600 dark:text-gray-400">{event.account_code}</td>
                                        <td className="px-6 py-4 text-gray-500 dark:text-gray-500 text-sm">{event.description || "-"}</td>
