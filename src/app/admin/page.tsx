        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500">
                    Manage requests, review approvals, and track activity.
                </p>
            </div>
                ...
                {["PENDING", "APPROVED", "REJECTED", "COMPLETED"].map(status => {
                    ...
                    return (
                        <button
                            ...
                            className={`glass-card !p-4 text-center transition-all hover:scale-[1.02] ${filterStatus === status ? "ring-2 ring-brand-400" : ""}`}
                        >
                            <p className="text-2xl font-bold text-gray-800">{count}</p>
                            <p className={`text-xs font-semibold mt-1 px-2 py-0.5 rounded-full inline-block ${getStatusColor(status)}`}>
                                {status}
                            </p>
                        </button>
                    );
                                ...
                                <div className="p-5 flex flex-col md:flex-row md:items-center gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-gray-400 mt-0.5">
                                            ฿{req.amount?.toLocaleString()} · {req.billing_type?.replace("_", " ")} · {new Date(req.created_at).toLocaleDateString("en-GB", { day: "2-digit", month: "short", year: "numeric" })}
                                        </p>
                                    </div>
