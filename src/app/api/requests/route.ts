...
/**
 * GET Method: Fetch requests from the database.
 * 
 * In Next.js App Router, any file named `route.ts` inside the `api` folder acts as an API endpoint.
 * The function name (GET, POST, PATCH, DELETE) automatically determines which HTTP method it handles.
 */
export async function GET(req: NextRequest) {
    try {
        ...
        // Role-based filtering: admin and manager see all, others see only their own
...
/**
 * POST Method: Create a new request.
 * 
 * This function handles incoming data when a user submits the "New Request" form.
 * It reads the JSON body, connects to Supabase, generates a PDF receipt, and sends a LINE notification.
 */
