        ...
        <div className="flex items-center justify-center min-h-[80vh]">
            <div className="max-w-md w-full animate-slide-up">
                <GlassCard className="text-center">
                    ...
                    {/* Message */}
                    <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500 mb-6">
                        {isError || isInfo
                            ? message
                            : isApproved
                    ...
                    {!isError && !isInfo && amount && (
                        <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 mb-6 text-sm">
                            <div className="flex justify-between">
                                <span className="text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">Event ID</span>
                                <span className="font-semibold text-gray-700 dark:text-gray-200">{eventId}</span>
                            </div>
