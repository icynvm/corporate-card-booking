    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[80vh] text-center">
            ...
            <div className="animate-slide-up">
                ...
                <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500 text-lg mb-10 max-w-md mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 w-full max-w-3xl">
                {[
                    ...
                    <div key={feature.title} className="glass-card-hover p-6 text-center">
                        ...
                        <h3 className="font-semibold text-gray-700 dark:text-gray-200 mb-1">{feature.title}</h3>
                        <p className="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500">{feature.desc}</p>
                    </div>
                ))}
            </div>
        </div>
