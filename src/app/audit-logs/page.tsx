                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                                        ...
                                        <span className="text-[10px] sm:text-xs text-gray-400 font-mono">{log.entity_type}</span>
                                        <span className="text-[10px] text-gray-300 hidden sm:inline">•</span>
                                        <span className="text-[10px] sm:text-xs text-gray-400 font-mono break-all">{log.entity_id?.substring(0, 8)}...</span>
                                    </div>
                                ...
                                {/* Timestamp */}
                                <div className="text-right text-[10px] sm:text-xs text-gray-400 whitespace-nowrap flex-shrink-0">
